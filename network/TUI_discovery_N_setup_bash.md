...
> Discovery Server 구조 및 개념 → [fastdds_and_discovery_server.md](../concepts/fastdds_and_discovery_server.md)
...
- `ROS_DISCOVERY_SERVER` 형식/세미콜론 규칙, `ROS_SUPER_CLIENT` 역할 → [fastdds_and_discovery_server.md](../concepts/fastdds_and_discovery_server.md)
